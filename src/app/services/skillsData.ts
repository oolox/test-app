...
export const skillsData: skillsItemType[] = [
  ...
  { label: 'SSO (Okta/Google)', type: 'Integrations', rating: 6 , years: 1 },
  ...
  { label: 'Heroku / Deployment', type: 'Tools', rating: 7 , years: 3 },
  { label: 'Figma', type: 'Tools', rating: 6 , years: 2 },
  { label: 'Adobe', type: 'Tools', rating: 7 , years: 10 },
